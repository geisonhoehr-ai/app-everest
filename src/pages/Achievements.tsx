            ...
            {unlockedAchievements.length > 0 ? (
              ...
              <MagicCard variant="glass" size="lg" className="text-center py-12">
                <div className="max-w-md mx-auto">
                  ...
                  <Button className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white px-8 py-3 rounded-2xl font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg">
                    Começar a Estudar
                  </Button>
                </div>
              </MagicCard>

    ...
    <div className="space-y-6">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 gap-2 p-2 rounded-2xl border border-border">
            ...
            <TabsTrigger value="modules" className="rounded-xl text-xs md:text-sm">
            ...
            <TabsTrigger value="performance" className="rounded-xl text-xs md:text-sm">
              <Server className="h-3 w-3 md:h-4 md:w-4 md:mr-2" />
              <span className="hidden md:inline">Performance</span>
              <span className="md:hidden">Perf</span>
            </TabsTrigger>
            <TabsTrigger value="permissions" className="rounded-xl text-xs md:text-sm">

...
export default function AdminCourseClassesPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (allClassesError) {
        console.error('Error loading classes:', allClassesError)
      ...
      console.log('✅ Available classes with assignment status:', classesWithAssignment)
              ...
              <div className="max-h-[400px] overflow-y-auto">
                <div className="space-y-2">
                  {(() => {
                    ...
                    console.log('🎯 Unassigned classes to show:', unassignedClasses)
                    console.log('📊 Total available classes:', availableClasses.length)
                    console.log('📊 Unassigned classes:', unassignedClasses.length)

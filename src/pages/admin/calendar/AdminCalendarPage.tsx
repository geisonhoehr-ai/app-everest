...
const eventConfig = {
  LIVE_CLASS: {
    ...
    bg: 'bg-emerald-500/100/10 border-emerald-500/20',
    dot: 'bg-emerald-500/100',
    badge: 'bg-emerald-500/100/10 text-emerald-600 border-emerald-500/20 dark:text-emerald-400',
  },
  SIMULATION: {
    label: 'Simulado',
    icon: Target,
    color: 'text-blue-600 dark:text-blue-400',
    bg: 'bg-blue-500/100/10 border-blue-500/20',
    dot: 'bg-blue-500/100',
    badge: 'bg-blue-500/100/10 text-blue-600 border-blue-500/20 dark:text-blue-400',
  },
  ESSAY_DEADLINE: {
    label: 'Redação',
    icon: PenTool,
    color: 'text-rose-600 dark:text-rose-400',
    bg: 'bg-rose-500/100/10 border-rose-500/20',
    dot: 'bg-rose-500/100',
    badge: 'bg-rose-500/100/10 text-rose-600 border-rose-500/20 dark:text-rose-400',
  },
  GENERAL: {
    label: 'Geral',
    icon: Info,

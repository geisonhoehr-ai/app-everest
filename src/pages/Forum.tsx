          ...
          <CardContent className="pt-6">
            <div className="space-y-4 md:space-y-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full bg-primary/10 border border-primary/20">
            ...
            <div className="flex flex-col md:flex-row gap-3 md:gap-4">
              ...
              <div className="flex gap-2 w-full md:w-auto">
                ...
                <Button
                  ...
                  className="flex-1 md:flex-none text-white font-semibold hover:shadow-md"
                >
              ...
              {filteredTopics.length === 0 ? (
                ...
                <div className="space-y-4">
                  {filteredTopics.map((topic) => (
                    <div
                      key={topic.id}
                      className="group p-6 rounded-xl bg-muted/20 border border-border/50 hover:border-primary/30 transition-colors duration-300 hover:shadow-md"
                    >
          ...
          <CardContent className="pt-6">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div
                  className="p-6 rounded-xl bg-blue-500/10 border border-blue-500/20 hover:border-blue-500/30 transition-transform duration-300 hover:shadow-md inline-flex items-center justify-center cursor-pointer"
                  onClick={() => setIsDialogOpen(true)}
                >
                ...
                <div className="p-6 rounded-xl bg-purple-500/10 border border-purple-500/20 hover:border-purple-500/30 transition-transform duration-300 hover:shadow-md inline-flex items-center justify-center">
                  <div className="flex flex-col items-center">
                    <div className="flex items-center gap-3 mb-3">

          ...
          <MagicCard variant="premium" size="lg" className="text-center py-16">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button asChild className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white px-8 py-3 rounded-xl font-semibold transition-transform duration-300 hover:scale-105 hover:shadow-lg inline-flex items-center justify-center">
                  <Link to="/">
                ...
                <Button 
                  ...
                  className="bg-card/50 backdrop-blur-sm border-border/50 hover:bg-card/80 px-8 py-3 rounded-xl font-semibold transition-transform duration-300 hover:scale-105"
                >
